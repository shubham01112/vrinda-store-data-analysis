-- FINANCE ANALYTICS
/* Task: As a product owner, i want to generate a report of individual products sales (aggregated on monthly basis at the product code level) 
   for croma india customer for FY=21 so that i can track individual product sales and run further further analytics on it in excel.
...
-- a. Grabing customer codes for Croma india
	SELECT * FROM dim_customer WHERE customer like "%croma%" AND market="india";

-- b. Geting all the sales transaction data from fact_sales_monthly table for that customer(croma: 90002002) in the fiscal_year 2021
...
-- Generate monthly gross sales report using stored procedure
